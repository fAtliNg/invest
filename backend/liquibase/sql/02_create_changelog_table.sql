...
('v1.0.2', '2026-01-17', 'Добавлен новый раздел "Котировки" с детальной аналитикой и интерактивными графиками инструментов Мосбиржи. Проведена оптимизация производительности кредитного калькулятора, улучшена точность расчетов и отзывчивость интерфейса.')
